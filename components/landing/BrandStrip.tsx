    ...
    <section className="relative overflow-hidden py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24 opacity-80 hover:opacity-100 transition-opacity">
          <div className="relative w-full max-w-[400px] aspect-[16/9] overflow-hidden rounded-[32px] shadow-2xl border border-white/10 group">
            <Image
          ...
          <div className="relative w-full max-w-[280px] aspect-[3/4] overflow-hidden rounded-[32px] shadow-2xl border border-white/10 group">
            <Image
              src="/LADATEUK.webp"
