  ...
  try {
    ...
    await sql`
      INSERT INTO auth.users (
        ...
        '00000000-0000-0000-0000-000000000000', ${userId}, 'authenticated', 'authenticated', ${email}, 'password', now(), '{"provider":"email","providers":["email"]}', '{"full_name": "Test", "role": "visiteur", "access_level": "classic"}', now(), now(), '', '', '', ''
      )
    `;
    console.log('Success');
