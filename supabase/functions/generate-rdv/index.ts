  ...
  <tr>
    <td style="background:#4A072B;padding:32px">
      <table role="presentation" width="100%">
        <tr><td><img src="${baseUrl}/pro_connect_fr.webp" width="180" height="auto" alt="PROMOTE-CONNECT" style="display:block;border:0" /></td></tr>
        <tr><td><h1 style="margin:16px 0 0;color:#ffffff;font-size:24px;font-weight:700">${cfg.label}</h1></td></tr>
      </table>
    </td>
  </tr>
  <tr>
    <td style="padding:32px">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="padding:0 0 16px">
          <table role="presentation" width="100%"><tr><td style="padding:12px 16px;background:#f6f8fb;border-radius:12px">
